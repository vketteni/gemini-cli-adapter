...
import { Type } from '../types/compat.js';
...
---`;
      ...
      const resultText = getResponseText(convertGoogleResponse(result)) || '';
      return {
  ...
  async execute(
    ...
    try {
      ...
      let responseText = getResponseText(convertGoogleResponse(response)) || '';
