...
import { FunctionDeclaration, Type } from '../types/compat.js';
// Keep Google-specific imports that are still needed
...
export class DiscoveredMCPTool extends BaseTool<ToolParams, ToolResult> {
  ...
  override get schema(): FunctionDeclaration {
    return {
      name: this.name, // name is guaranteed to be string from BaseTool
      description: this.description,
      parameters: this.parameterSchemaJson as any, // Cast to maintain compatibility
    };
  }
